...
<a href="./test_phytoplankton/" target="_blank" rel="noopener noreferrer">ここ</a>を新しいタブで開いてファイルを<b>test_phytoplankon</b>フォルダの中に保存しましょう。

##### [2.2] 微生物の＊＊＊に関するデータのダウンロード
<a href="./test_ecoplate/" target="_blank" rel="noopener noreferrer">ここ</a>を新しいタブで開いてファイルを<b>test_ecoplate</b>フォルダの中に保存しましょう。
